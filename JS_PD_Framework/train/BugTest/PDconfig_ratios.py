...
def ratios(data_decompose):
    data_decompose.genRatio("Total Sales / Turnover", "Total Assets")
    data_decompose.genRatio('Total Assets', 'Total Liabilities')
    data_decompose.genRatio("EBITDA", "Total Assets")
    data_decompose.genRatio("Working Capital", "Total Assets")
    data_decompose.genRatio("Retained Earnings", "Total Assets")
#     data_decompose.genRatio("EBITDA", "Total Sales / Turnover", useLog=True, useDiff=True, periodBeforePre=1)
#    data_decompose.genRatio("Property, Plant & Equipment", "Total Liabilities", periodBeforePre=1)
#    data_decompose.genRatio("Cash At Bank", "Total Assets", periodBeforePre=1)
...
#     data_decompose.genRatio('Total Assets', useLog=True, periodBeforePre=1)
...
#     data_decompose.genRatio('Total Liabilities', 'Total Assets', periodBeforePre=1)
